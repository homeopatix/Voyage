...
-----------------------------------------
    ...
    if(what == "mariner")then
        mapLabel:SetBackground(marinerLocationsMap[what .. images]["mapHex"]);
        MapWindow:SetText(marinerLocationsMap[what .. images]["texte"]);
        DisplayIcon(what, images);
    end
...
function DisplayIcon(what, images)
    ...
    elseif(what == "mariner")then 
        posx = marinerLocationsMap[what .. images]["coordx"];
        posy = marinerLocationsMap[what .. images]["coordy"];
    end


    --Turbine.Shell.WriteLine(teleportLocationsMap[what .. images]["mapHex"]);
    --Turbine.Shell.WriteLine(teleportLocationsMap[what .. images]["coordx"]);
    --Turbine.Shell.WriteLine(teleportLocationsMap[what .. images]["coordy"]);
