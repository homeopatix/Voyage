...
function GenerateOptionsWindowHousing(value)
		...
		local posx = 40;
			...
			OptionsWindowHousing.Message:SetPosition(windowWidth/2 - 150, posx ); 
			OptionsWindowHousing.Message:SetTextAlignment(Turbine.UI.ContentAlignment.MiddleCenter); 
			...
			checkBox1:SetPosition(120, posx);
			...
			checkBox2:SetPosition(120, posx);
			...
			checkBox3:SetPosition(120, posx);
			...
			checkBox4:SetPosition(120, posx);
			...
			checkBox5:SetPosition(120, posx);
			...
			checkBox6:SetPosition(120, posx);
			...
			checkBox7:SetPosition(120, posx);
			...
			checkBox8:SetParent( OptionsWindowHousing );
			checkBox8:SetSize(200, 20); 
			checkBox8:SetFont(Turbine.UI.Lotro.Font.Verdana16);
			checkBox8:SetText(Strings.PluginHouse8);
			checkBox8:SetPosition(120, posx);
			checkBox8:SetVisible(true);
			checkBox8:SetForeColor( Turbine.UI.Color( 0.7, 0.6, 0.2 ));
			if(value == "personal")then
				if(settings["personalHouseMap"]["value"] == 8)then
			...
			if(value == "confrerie")then
				if(settings["confrerieHouseMap"]["value"] == 8)then
					checkBox8:SetChecked(true);
				else
					checkBox8:SetChecked(false);
				end
			...
			if(value == "confrerieFriend")then
				if(settings["confrerieFriendHouseMap"]["value"] == 8)then
					checkBox8:SetChecked(true);
				else
					checkBox8:SetChecked(false);
				end
			...
			if(value == "premium")then
				if(settings["premiumHouseMap"]["value"] == 8)then
					checkBox8:SetChecked(true);
				else
					checkBox8:SetChecked(false);
				end
			...
			buttonValiderHousing:SetPosition(windowWidth/2 - 125, posx);
...
function ValidateChangesHousing(value)
		buttonValiderHousing.MouseClick = function(sender, args)
				...
				if(value == "personal")then
					...
					elseif (checkBox8:IsChecked()) then
						settings["personalHouseMap"]["value"] = 8;
					else
				...
				if(value == "confrerie")then
					...
					elseif (checkBox8:IsChecked()) then
						settings["confrerieHouseMap"]["value"] = 8;
					else
				...
				if(value == "confrerieFriend")then
					...
					elseif (checkBox8:IsChecked()) then
						settings["confrerieFriendHouseMap"]["value"] = 8;
					else	
				...
				if(value == "premium")then
					...
					elseif (checkBox8:IsChecked()) then
						settings["premiumHouseMap"]["value"] = 8;
					else
...
function CheckerTester()
	...
	function checkBox8:CheckedChanged()
